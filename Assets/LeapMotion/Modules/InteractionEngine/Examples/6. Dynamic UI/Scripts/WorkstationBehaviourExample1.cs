...
namespace Leap.Unity.Examples {
  ...
  [AddComponentMenu("")]
  public class WorkstationBehaviourExample1 : MonoBehaviour {
    ...
    private Vector3 determineWorkstationPosition() {
      return workstationPositionFunc(ZEDCamera.transform.position, ZEDCamera.transform.rotation,
    ...
    private Quaternion determineWorkstationRotation(Vector3 workstationPosition) {
      return workstationRotationFunc(ZEDCamera.transform.position, workstationPosition);
    }
